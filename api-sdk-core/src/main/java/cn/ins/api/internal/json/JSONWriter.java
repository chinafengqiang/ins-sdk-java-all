package cn.ins.api.internal.json;
...
public class JSONWriter {
    Logger logger = Logger.getLogger("JSONWriter");
    ...
    private void date(Date date) {
        if (this.format == null) {
            this.format = new SimpleDateFormat(InsConstants.DATE_TIME_FORMAT);
            this.format.setTimeZone(TimeZone.getTimeZone(InsConstants.DATE_TIMEZONE));
        }
        add("\"");
